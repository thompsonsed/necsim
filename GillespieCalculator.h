...
namespace necsim
{
    ...
    public:
        ...
        {
            auto lineages = selectTwoRandomLineages(origin);
        ...
        {
            unsigned long local_individuals = getNumberIndividualsAtLocation(
                ...
                heap.emplace_back(
                        GillespieHeapNode(Cell(x, y),
                                          (probabilities.get(y, x).calcTimeToNextEvent(
                                                  mean_death_rate, local_individuals,
        ...
        {
            unsigned long max_number_individuals = landscape->getVal(location.x, location.y, location.xwrap,
                                                                     location.ywrap,
                                                                     generation);
